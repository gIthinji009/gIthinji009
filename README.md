## Hi there 👋
# 💫 About Me:
Hi, I'm **Laban Githinji**, a passionate software engineer focused on creating impactful digital solutions.  
I specialize in building full-stack applications using modern JavaScript and Python frameworks. I am a graduate at Moringa school and currently a student at Riara University pursuing Computer Science

I enjoy transforming ideas into functional, clean, scalable systems — whether web apps, backend APIs, or full business workflows.

Currently, I'm working on several exciting projects including:
- Full-stack business management tools  
- Portfolio-ready frontend apps  
- API-driven backends with authentication + automation  
...
**Frontend:**  
HTML5 • CSS3 • JavaScript • React • React Router • React Native • React Query • Context API • Vite • Next.js • Angular • Bootstrap

**Backend:**  
Python • Django • Flask • Node.js • Springboot • Express • SQLite • Firebase
